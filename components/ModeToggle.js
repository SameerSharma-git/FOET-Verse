...
export const ModeToggle = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "size-8 cursor-pointer rounded-full bg-black p-0 transition-all duration-300 active:scale-95",
        className,
      )}
      onClick={toggleTheme}
...
// Valid animation variants: "circle", "rectangle", "gif", "polygon", "circle-blur"
// Valid animation starts: "top-left", "top-right", "bottom-left", "bottom-right", "center",
// "top-center", "bottom-center", "bottom-up", "top-down", "left-right", "right-left"

// Animation object shape:
// {
//   name: string - the name of the animation
//   css: string - the CSS for the animation
// }
